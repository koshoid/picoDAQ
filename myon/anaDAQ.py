...
# procs.append(
#     mp.Process(
#         name = 'pulseFilterd', target = pulseFilterd,
#         args = (BM, PSconf, cId_pf),
#         kwargs = {
#             'filterRateQueue':    filtRateQ,
#             'histogramQueue':     histQ,
#             'VoltageSignalQueue': VSigQ,
#             'PulseDisplayQueue':  PulseQ,
#             'logPulses':          True,
#             'verbosity':          2
#         }
#     )
